...
authors: C. Sens‐Schönfelder, L. Margerin, M. Campillo
year: 2009
...
$$
\begin{aligned}
\frac{\Delta N^P(\mathbf{n},\mathbf{r})}{N^P(\mathbf{n},\mathbf{r}}=-\Delta l\left(g_0^{PP}+g_0^{PS}\right)-\Delta l\frac{\omega}{\alpha_0 {}^IQ^P}\\
+
\end{aligned}
$$
